...
import { Lamp, Moon, Volume2, VolumeX } from 'lucide-react'
 ...
 * while scrolling. Houses the sound fx toggle and the light/dark "lamp"
 * toggle. Add more buttons here later using railButtonClass().
 */
